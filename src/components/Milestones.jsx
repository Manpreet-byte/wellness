    ...
    <section id="milestones" className="py-20 md:py-28 bg-[#d9efe3] overflow-hidden relative">
      ...
      <div className="animate-this up" data-reveal-delay="120">
        <div ref={scrollerRef} className="overflow-x-auto no-scrollbar scroll-smooth">
          <div className="min-w-[360px] sm:min-w-[800px] md:min-w-[1180px] lg:min-w-[1420px] flex">
            {milestones.map((milestone, idx) => {
              const isActive = idx === activeIndex;
              return (
                <div
                  key={`${milestone.year}-${idx}`}
                  className={`milestone-item relative flex-shrink-0 w-[300px] sm:w-[340px] md:w-[360px] lg:w-[380px] ${isActive ? 'active' : ''}`}
                  data-ms-item
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full text-left px-5 sm:px-7 md:px-8 pt-8 sm:pt-10 pb-4 sm:pb-6"
                  >
                  ...
                  <div className="h-14 sm:h-16 md:h-20 border-y border-[#1b6b56]/12 bg-[repeating-linear-gradient(90deg,rgba(27,107,86,0.08)_0_2px,transparent_2px_16px)]" />

                  <div className="px-5 sm:px-7 md:px-8 pb-2 md:pb-0">
                      ...
                      <div className="pt-8 sm:pt-10">
                        <div className="overflow-hidden rounded-none">
                          <img
                            src={milestone.image}
                            alt={milestone.title}
                            className="w-full h-[140px] sm:h-[160px] md:h-[170px] lg:h-[185px] object-cover animate-mask"
                            loading="lazy"
                            decoding="async"
                          />
                        </div>
                        <p className="mt-4 sm:mt-5 text-xs sm:text-sm md:text-base leading-6 sm:leading-7 wf-text-secondary max-w-[300px]">
                          {milestone.description}
                        </p>
                      </div>
                    </div>
                    {!isActive ? <div className="h-[120px] sm:h-[140px] md:h-[150px] lg:h-[170px]" /> : null}
                  </div>
                </div>
              );
            })}
