                    ...
                    <div className="pt-8">
                      <div className="bg-white/30 rounded-xl p-0.5 inline-block">
                        <img
                          src={milestone.image}
                          alt={milestone.title}
                          className="w-full max-w-none sm:max-w-[280px] h-[170px] sm:h-[150px] object-cover rounded-lg shadow-sm transition-transform duration-700 hover:scale-[1.02] animate-mask"
                        />
                      </div>
