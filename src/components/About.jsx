  ...
  return (
    <section id="about" className="bg-white">
      <div className="w-full overflow-hidden border-t border-[#1b6b56]/10">
        <div className="relative min-h-[680px] md:min-h-[720px] lg:min-h-[760px]">
          {/* Right image */}
          ...
          <div className="relative z-10 h-full">
            <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-12 lg:px-16 h-full flex items-center py-16 md:py-0">
