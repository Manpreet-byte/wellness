      ...
      <div className="w-full mx-auto px-0 pr-4 sm:pr-6 md:pr-10 lg:pr-12 pt-8 md:pt-10 pb-0 overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          <div className="px-4 sm:px-6 md:px-10 lg:px-0 lg:pl-6">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-light text-[#111] mb-10 animate-this right">
              How It All Started?
            </h2>
            ...
            <p className="text-sm md:text-base text-[#6b7a75] leading-relaxed mb-7 max-w-[560px] animate-this right">
            ...
            <p className="text-sm md:text-base text-[#6b7a75] leading-relaxed max-w-[560px] animate-this right">
